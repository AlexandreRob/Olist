    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='api.orders')),
            ],
            options={
                'db_table': 'review',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api.seller')),
            ],
            options={
                'db_table': 'product',
            },
